...
const POSTS = [
  ...
  { type: "FOUND", title: "Navy metal water bottle with stickers", description: "Found a dark blue insulated bottle on a desk after class. Has a bunch of stickers on it. Holding onto it for now.", category: "WATER_BOTTLE", location: "MUSC", locationDetail: "near Compass", occurredOn: daysAgo(1) },
  ...
  { type: "FOUND", title: "Student card — first name Priya", description: "Found a McMaster student card on the floor by the stairs. Handed it to the desk but posting here in case they check.", category: "KEYS_AND_CARDS", location: "JHE", occurredOn: daysAgo(3) },
  ...
  { type: "FOUND", title: "Set of keys with a red carabiner", description: "Three keys on a red carabiner with a small bottle opener. Found on a bench outside.", category: "KEYS_AND_CARDS", location: "OUTDOOR_CAMPUS_GROUNDS", occurredOn: daysAgo(5) },
  ...
  { type: "FOUND", title: "Textbook — Introduction to Psychology", description: "Someone left a psych textbook in the lecture hall. Name written inside the front cover.", category: "BOOKS_AND_NOTES", location: "PSYCHOLOGY", locationDetail: "room 155", occurredOn: daysAgo(2) },
  ...
  { type: "FOUND", title: "Green Jansport backpack in the Refectory", description: "Green Jansport left under a table at lunch. Didn't open it beyond checking for a name.", category: "BAGS", location: "REFECTORY", occurredOn: daysAgo(2) },
] as const;
